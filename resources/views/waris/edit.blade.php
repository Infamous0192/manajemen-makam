...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form action="{{ route('waris.update', $waris->id) }}" method="POST">
                <div class="card-body">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control selectlive" name="id_mendiang">
                                <option value="" {{old('id_mendiang', $waris->mampu->id)=='' ? 'selected' : '' }}>-
                                    pilih -</option>
                                @foreach ($mampu as $row)
                                <option value="{{$row->id}}" {{old('id_mendiang', $waris->id_mendiang)==$row->id ?
                                    'selected' : ''
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control selectlive" name="status_waris">
                                <option value="" {{old('status_waris', $waris->status_waris)=='' ? 'selected' : '' }}>-
                                    pilih -</option>
                                <option value="ayah" {{old('status_waris', $waris->status_waris)=='ayah' ? 'selected' :
                                    '' }}>Ayah</option>
                                <option value="ibu" {{old('status_waris', $waris->status_waris)=='ibu' ? 'selected' : ''
                                    }}>Ibu</option>
                                <option value="anak" {{old('status_waris', $waris->status_waris)=='anak' ? 'selected' :
                                    '' }}>Anak</option>
                                <option value="paman" {{old('status_waris', $waris->status_waris)=='paman' ? 'selected'
                                    : '' }}>Kerabat Ibu
                                </option>
                                <option value="bibi" {{old('status_waris', $waris->status_waris)=='bibi' ? 'selected' :
                                    '' }}>Kerabat Ayahh
                                </option>
                            </select>
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nik_waris" placeholder="Masukan NIK" class="form-control"
                                value="{{ old('nik_waris', $waris->nik_waris) }}">
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nama_waris" placeholder="Masukan Nama" class="form-control"
                                value="{{ old('nama_waris', $waris->nama_waris) }}">
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="tempat_waris" placeholder="Masukan Tempat Lahir"
                                class="form-control" value="{{ old('tempat_waris', $waris->tempat_waris) }}">
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="date" name="tanggal_waris" placeholder="Masukan Tanggal Lahir"
                                class="form-control" value="{{ old('tanggal_waris', $waris->tanggal_waris) }}">
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control selectpicker" name="kelamin">
                                <option value="" {{ old('kelamin', $waris->kelamin) == '' ? 'selected' : '' }}>- pilih -
                                </option>
                                <option value="Laki" {{ old('kelamin', $waris->kelamin) == 'Laki' ? 'selected' : ''
                                    }}>Laki-laki</option>
                                <option
                                    value="Wanita {{ old('kelamin', $waris->kelamin) == 'Wanita' ? 'selected' : '' }}">
                                    Perempuan</option>
                            </select>
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="kecamatan" placeholder="Masukan Kecamatan" class="form-control"
                                value="{{ old('kecamatan', $waris->kecamatan) }}">
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="kabupaten" placeholder="Masukan Kabupaten" class="form-control"
                                value="{{ old('kabupaten', $waris->kabupaten) }}">
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="provinsi" placeholder="Masukan Provinsi" class="form-control"
                                value="{{ old('provinsi', $waris->provinsi) }}">
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control selectlive" name="agama">
                                <option value="" {{old('agama', $waris->agama)=='' ? 'selected' : '' }}>- pilih -
                                </option>
                                <option value="Islam" {{old('agama', $waris->agama)=='Islam' ? 'selected' : '' }}>Islam
                                </option>
                                <option value="Kristen" {{old('agama', $waris->agama)=='Kristen' ? 'selected' : ''
                                    }}>Kristen</option>
                                <option value="Katolik" {{old('agama', $waris->agama)=='Katolik' ? 'selected' : ''
                                    }}>Katholik</option>
                                <option value="Hindu" {{old('agama', $waris->agama)=='Hindu' ? 'selected' : '' }}>Hindu
                                </option>
                                <option value="Buhda" {{old('agama', $waris->agama)=='Buhda' ? 'selected' : '' }}>Budha
                                </option>
                                <option value="Konghucu" {{old('agama', $waris->agama)=='Konghucu' ? 'selected' : ''
                                    }}>Konghucu
                                </option>
                            </select>
                            @if ($errors->get('agama'))
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="negara" placeholder="Masukan Kewarganegaraan" class="form-control"
                                value="{{ old('negara', $waris->negara) }}">
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="pekerjaan" placeholder="Masukan Pekerjaan" class="form-control"
                                value="{{ old('pekerjaan', $waris->pekerjaan) }}">
