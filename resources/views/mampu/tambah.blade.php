...
<div class="row">
    <div class="col-12">
        <div class="card" style="margin-bottom: 10rem">
            ...
            <form action="{{ route ('mampu.store') }}" method="POST">
                <div class="card-body">
                    @csrf
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="alamat_ktp" placeholder="Masukan Alamat KTP" class="form-control"
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="alamat_now" placeholder="Masukan Alamat Sekarang"
                                class="form-control" value="{{ old('alamat_now') }}">
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control selectlive" name="agama">
                                ...
                                <option value="Buhda" {{old('agama')=='Budha' ? 'selected' : '' }}>Budha
                                </option>
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control selectlive" name="pendidikan">
                                <option value="" {{old('pendidikan')=='' ? 'selected' : '' }}>-
                                    pilih -</option>
                                <option value="Tidak Sekolah" {{old('pendidikan')=='Tidak Sekolah' ? 'selected' : '' }}>
                                    Tidak Sekolah</option>
                                <option value="Tidak lulus SD" {{old('pendidikan')=='Tidak lulus
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control selectpicker" name="kawin">
                                <option value="" {{old('kawin')=='' ? 'selected' : '' }}>- pilih -
                                </option>
                                <option value="Sudah menikah" {{old('kawin')=='Sudah menikah' ? 'selected' : '' }}>Kawin
                                </option>
                                <option value="Belum Menikah" {{old('kawin')=='Belum Menikah' ? 'selected' : '' }}>Tidak
                                    Kawin</option>
                            </select>
                            @if ($errors->get('kawin'))
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control selectpicker" name="tinggal">
                                <option value="" {{old('tinggal')=='' ? 'selected' : '' }}>- pilih -
                                </option>
                                <option value="Tetap" {{old('tinggal')=='Tetap' ? 'selected' : '' }}>Tetap</option>
                                <option value="Kontrak" {{old('tinggal')=='Kontrak' ? 'selected' : '' }}>Kontrak
                                </option>
                            </select>
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="tempat_dimakamkan" placeholder="Masukan Tempat Dimakamkan"
                                class="form-control" value="{{ old('tempat_dimakamkan') }}">
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="date" name="tanggal_meninggal" placeholder="Masukan Tanggal meninggal"
                                class="form-control" value="{{ old('tanggal_meninggal') }}">
                    ...
                    <div class="form-grup row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="date" name="tanggal_dimakamkan" placeholder="Masukan Tanggal pemakaman"
                                class="form-control" value="{{ old('tanggal_dimakamkan') }}">
