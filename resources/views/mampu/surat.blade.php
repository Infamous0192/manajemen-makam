    ...
    <div class="mx-auto">
      ...
      <table>
        <tr>
          <td class="pr-4">Nama</td>
          <td class="px-2">:</td>
          <td>{{ $mampu->nama_lengkap }}</td>
        </tr>
        <tr>
          <td class="pr-4">Tempat/Tanggal Lahir</td>
          <td class="px-2">:</td>
          <td>{{ $mampu->tempat_lahir }}, {{ $mampu->tanggal_lahir }}</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="px-2">:</td>
          <td>{{ $mampu->jenis_kelamin }}</td>
        </tr>
        <tr>
          <td class="pr-4">Pekerjaan</td>
          <td class="px-2">:</td>
          <td>{{ $mampu->pekerjaan }}</td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="pr-4">Alamat</td>
          <td class="px-2">:</td>
          <td>{{ $mampu->alamat_now }}</td>
        </tr>
      </table>

      <p class="mt-4">Adalah benar telah meninggal dunia :</p>

      <div class="">Tanggal Dikebumikan : {{ $mampu->tanggal_dimakamkan }}</div>
      <div>Tempat : {{ $mampu->tempat_dimakamkan }}</div>
