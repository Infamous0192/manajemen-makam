            ...
            <h3 class="card-title"><strong>Edit Data Pengguna</strong></h3>
                ...
                <div class="card-body">
                    ...
                    <div class="form-grup row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" placeholder="Masukan nama" required class="form-control" value="{{ $user->name}}">
                    </div>
                </div>
                ...
                <div class="form-grup row">
                    ...
                    <div class="col-sm-10">
                        <input type="email" name="email" placeholder="Masukan Email" required class="form-control"value="{{ $user->email}}">
                </div>
            </div>
